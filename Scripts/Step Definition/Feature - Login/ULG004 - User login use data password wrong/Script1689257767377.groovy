...
WebUI.callTestCase(findTestCase('Pages/User Login/Input Password'), [('password') : 'test'], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/User Login/Tap Login'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/User Login/Read Error Message'), [('expected') : 'Username and password do not match any user in this service.'], 
