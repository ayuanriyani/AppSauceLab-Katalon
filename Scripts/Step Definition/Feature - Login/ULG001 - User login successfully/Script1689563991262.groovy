...
WebUI.callTestCase(findTestCase('Pages/Header Page/Tap Icon Burger button'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Burger Button/Tap Menu Logout'), [:], FailureHandling.STOP_ON_FAILURE)
